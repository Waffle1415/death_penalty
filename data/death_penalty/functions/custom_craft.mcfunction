...
execute as @s at @s if block ~ ~-1 ~ minecraft:dropper{Items:[{Slot:0b,id:"minecraft:dirt",Count:64b},{Slot:1b,id:"minecraft:dirt",Count:64b,},{Slot:2b,id:"minecraft:dirt",Count:64b},{Slot:3b,id:"minecraft:dirt",Count:64b},{Slot:4b,id:"minecraft:gold_block",Count:1b},{Slot:5b,id:"minecraft:dirt",Count:64b},{Slot:6b,id:"minecraft:dirt",Count:64b},{Slot:7b,id:"minecraft:dirt",Count:64b},{Slot:8b,id:"minecraft:dirt",Count:64b}]} at @s run function death_penalty:custom_item/dirt
