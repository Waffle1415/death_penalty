...
summon zombie ~ ~ ~ {PersistenceRequired:1b,Glowing:1b,DeathLootTable:"summon",CanBreakDoors:1b,Tags:["summon"],CustomName:'{"text":"プレイヤー？ Lv5","color":"red"}',HandItems:[{id:"minecraft:iron_sword",Count:1b,tag:{Enchantments:[{id:"minecraft:sharpness",lvl:5s}]}},{}],HandDropChances:[0.000F,0.085F],ArmorItems:[{},{},{id:"minecraft:iron_chestplate",Count:1b,tag:{Enchantments:[{id:"minecraft:protection",lvl:5s}]}},{id:"minecraft:player_head",Count:1b}],ArmorDropChances:[0.085F,0.085F,0.000F,100.000F]}
